...
class _MortgageAppState extends State<MortgageApp> {
          ...
          children: <Widget>[
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(" ${ (_homePrice > 0 && _interest > 0.0)
                        ...
                        _homePrice, _interest, _lengthOfLoan)}"
                        : ""}"
                    ,style: TextStyle(
                        color: secondaryBackgroundWhite
                      ),)
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  border: Border.all(
                      color: secondaryDeepPurple,//Colors.blueGrey.shade100, //TODO: theme this!
                    ...
                    Column(
                      children: <Widget>[
                        Slider(
                            ...
                            //TODO: Theme this!
                            inactiveColor: Theme.of(context).primaryColor,//Colors.grey,
                            //TODO: Theme this!
                            // divisions: 10,
                            value: _interest,
  ...
  calculateMonthlyPayment(double homePrice, double interest, int loanLength) {
    ...
    if (homePrice < 0 || homePrice
        .toString()
        .isEmpty || homePrice == null) {
      //no go!
      // _homePrice = 0.0;
    } else {
